...
public class NodeDataRulePanel extends JPanel
{
    ...
    public NodeDataRulePanel()
    {
        ...
        constrain(p, new JLabel("Radius: "), 0, 3, 1, 1);
    ...
    public NodeDataRulePanel(NodeDataRule prev)
    {
        this();
        this.prev = prev;
    }
    ...
    public boolean save()
    {
        ...
        if(prev == null)
        {
            prev = new NodeDataRule();
            addRule = true;
        }
        
        prev.setMinRadius(minWidth_);
        prev.setMaxRadius(maxWidth_);
